  ...
  return (
    <section>
      <div className="bg-linear-to-r from-purple-100 to-black-light h-70 md:h-100">
        <p
          className="text-center text-6xl md:text-[150px] text-gradient pt-30 md:pt-25"
          id="contact-title"
        >
          Contact Us
        </p>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="contact-card text-center p-6 bg-white/80 rounded-lg shadow-md hover:shadow-lg transition-shadow">
