  ...
  return (
    <section>
      <div className="bg-linear-to-r from-purple-100 to-black-light h-70 md:h-100">
        <p
          className="text-center text-5xl md:text-[150px] text-gradient pt-25"
          id="contact-title"
        >
          Contact Us
        </p>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12  ">
          <div className="contact-card max-w-sm  text-center p-6 bg-white/80 rounded-lg shadow-md hover:shadow-lg transition-shadow">
            <FaPhone className="text-4xl text-black-light mx-auto mb-4" />
            <h3 className="text-xl font-semibold text-black-light mb-2">
              Phone & WhatsApp
            </h3>
            <p className="text-gray-700">08141215567</p>
            <p className="text-sm text-gray-500 mt-2">
              Available for calls and messages
            </p>
          </div>

          <div className="contact-card w-90 text-center p-6 bg-white/80 rounded-lg shadow-md hover:shadow-lg transition-shadow">
            <FaEnvelope className="text-4xl text-black-light mx-auto mb-4" />
            <h3 className="text-xl font-semibold text-black-light mb-2">
              Email
            </h3>
            ...
            <p className="text-sm text-gray-500 mt-2">Send us your inquiries</p>
          </div>
        </div>
      </div>
